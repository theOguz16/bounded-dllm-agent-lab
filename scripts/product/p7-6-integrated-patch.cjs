...
function replace(file, before, after) {
  ...
  if (pieces.length !== 2) {
    throw new Error(`${file}: expected exactly one matching source anchor, found ${pieces.length - 1}`);
  }
