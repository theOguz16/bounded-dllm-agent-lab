...
const childStages = [
  ...
  {
    name: "agent process control smoke",
    script: "scripts/smoke/agent-process-control-smoke.cjs"
  },
  {
  ...
  {
    name: "Codex process control smoke",
    script: "scripts/smoke/codex-agent-process-control-smoke.cjs"
  },
  {
  ...
  {
    name: "comparative agent runner smoke",
    script: "scripts/smoke/comparative-agent-runner-smoke.cjs"
  },
  {
  ...
  {
    name: "repair telemetry report smoke",
    script: "scripts/smoke/repair-telemetry-report-smoke.cjs"
  },
  {
    name: "targeted repair contract smoke",
  ...
  {
    name: "product stats smoke",
    script: "scripts/smoke/product-stats-smoke.cjs"
  },
  {
    name: "product task contract smoke",
...
async function main() {
  ...
  assert.equal(typeof runtime.parseProductTask, "function");
  assert.equal(typeof runtime.createProductTaskProviderInput, "function");
