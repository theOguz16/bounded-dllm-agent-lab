...
The P7.6 pull-request workflow uses fake SDKs with provider credentials unset. Offline success is not evidence of live-provider quota, account ownership, or successful real Codex execution.
