...
MODEL_PATH = os.environ.get("DREAM_SNAPSHOT", "/tmp/hf-cache/models--Dream-org--Dream-Coder-v0-Instruct-7B/snapshots/<snapshot-id>")
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        max_tokens = int(payload.get("max_tokens", MAX_NEW_TOKENS))
        text = generate_completion(message_text(messages), max_tokens)
