...
function buildPrompt(
  ...
  const system = [
    ...
    "seedFiles, requiredSymbols, and requiredTestFiles must be JSON arrays of plain strings only; never place objects inside these arrays.",
    "When taskContext.requiredOutcome provides seedFiles, requiredSymbols, requiredTestFiles, or plannedFiles, copy those required arrays exactly.",
    ...
    "changeKind must be exactly one of: bugfix, config, dependency, docs, feature, refactor, test. Never use modify, update, implementation, code_change, or enhancement.",
